...
class FireEventTest {
    ...
    void TestGetZoneID() {
        FireEvent e = new FireEvent(3, TaskType.FIRE_DETECTED,
                LocalTime.of(14, 3, 15), Severity.HIGH, FaultType.NONE, 1);
    ...
    void TestGetTimestamp() {
        ...
        FireEvent e = new FireEvent(3, TaskType.FIRE_DETECTED, t, Severity.HIGH, FaultType.NONE, 1);
    ...
    void TestToString() {
        FireEvent e = new FireEvent(7, TaskType.DRONE_REQUESTED,
                LocalTime.of(14, 10), Severity.MODERATE, FaultType.NONE, 1);
